...
from hockey.items import TeamItem, RosterItem, CapFriendlyRosterItem, CapFriendlyTeamStatsItem
from hockey.spiders.utils import TEAM_ABBREVIATIONS
...
class SubcategorySpider(CrawlSpider):
    ...
    def parse_item(self, response):
        ...
        l = SubcategoryLoader(item=SubcategoryItem(), response=response)
